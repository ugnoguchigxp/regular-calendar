 ...
 */
export function formatCalendarDate(date: Date, localeCode: string | undefined, type: DateFormatType): string {
    ...
    switch (type) {
        ...
        case "timeWithMs":
            ...
            } as Intl.DateTimeFormatOptions & { fractionalSecondDigits?: number }).format(date);
