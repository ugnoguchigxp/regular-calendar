...
import type {
	ScheduleEvent as RegularCalendarEvent,
	FacilityScheduleSettings as RegularCalendarSettings,
} from "../RegularCalendar/RegularCalendar.schema";
...
export function ConnectedCalendar({
	...
	const calendarEvents = allEvents as unknown as RegularCalendarEvent[];
	const calendarSettings = mergedSettings as RegularCalendarSettings;
