...
describe('settingsUtils', () => {
  ...
  it('should apply dark theme settings', () => {
    ...
    expect(mockElement.style.getPropertyValue('--background')).toBe('210 20% 10%');
    expect(mockElement.style.getPropertyValue('--foreground')).toBe('210 30% 96%');
  ...
  it('should apply light theme settings', () => {
    ...
    expect(mockElement.style.getPropertyValue('--background')).toBe('0 0% 100%');
    expect(mockElement.style.getPropertyValue('--foreground')).toBe('210 20% 10%');
