...
describe('DateDisplay', () => {
    ...
    it('shows day of week when showDayOfWeek is true', () => {
        render(
            <DateDisplay date={new Date('2025-01-01')} showDayOfWeek={true} />
        );
    ...
    it('handles monthDayShort format', () => {
        render(<DateDisplay date={new Date('2025-01-15')} format="monthDayShort" />);
    ...
    it('passes through other HTML attributes', () => {
        render(<DateDisplay date={new Date('2025-01-01')} data-testid="test-date" />);
