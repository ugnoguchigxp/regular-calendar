...
describe('FacilityStructureSettings', () => {
    ...
    it('creates, edits, and deletes groups/resources', async () => {
        ...
        await user.click(screen.getByRole('button', { name: /facility_action_add_group/i }));
        ...
        await user.click(screen.getByRole('button', { name: /facility_action_add_resource/i }));
        ...
        await user.click(within(resourceTag).getByRole('button', { name: /save_button/i }));
        expect(onUpdateResource).toHaveBeenCalledWith('r1', { name: 'Updated Room' });
