...
describe('ThemeProvider', () => {
    ...
    it('uses custom applier when provided', () => {
        ...
        render(
            <ThemeProvider config={{ density: 'normal' }} applier={mockApplier as any}>
                <TestChild />
            </ThemeProvider>,
        );
    ...
    it('applies theme with multiple config properties', () => {
        render(
            <ThemeProvider config={{ density: 'compact', radius: 0.5, fontSize: 0.875 }}>
                <TestChild />
            </ThemeProvider>,
        );
    ...
    it('supports undefined config', () => {
        render(
            <ThemeProvider config={undefined as any}>
                <TestChild />
            </ThemeProvider>,
        );
