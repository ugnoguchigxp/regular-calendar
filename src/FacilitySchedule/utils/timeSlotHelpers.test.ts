...
describe('timeSlotHelpers', () => {
  describe('generateTimeSlots', () => {
    ...
    it('should calculate correct slot durations', () => {
      ...
      const slot1Duration = parseInt(slots[0].endTime.split(':')[0]) - parseInt(slots[0].startTime.split(':')[0]);
      const slot2Duration = parseInt(slots[1].endTime.split(':')[0]) - parseInt(slots[1].startTime.split(':')[0]);
      const slot3Duration = parseInt(slots[2].endTime.split(':')[0]) - parseInt(slots[2].startTime.split(':')[0]);
      const slot4Duration = parseInt(slots[3].endTime.split(':')[0]) - parseInt(slots[3].startTime.split(':')[0]);
