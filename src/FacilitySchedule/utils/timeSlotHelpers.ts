import type { FacilityScheduleSettings, TimeSlot } from '../FacilitySchedule.schema';
...
export function generateTimeSlots(
  ...
  for (let i = 0; i < slotsPerDay; i++) {
    ...
    const slotEnd = i === slotsPerDay - 1 ? endMinutes : slotStart + slotDuration;
...
export function getTimeSlot(scheduleStart: Date, timeSlots: TimeSlot[]): TimeSlot | null {
