...
import * as useScheduleDataModule from './hooks/useScheduleData';
import * as useScheduleEventHandlersModule from './hooks/useScheduleEventHandlers';
...
describe('FacilitySchedule', () => {
    ...
    it('applies custom className', () => {
        const { container } = render(<FacilitySchedule {...mockProps} className="custom-class" />);
