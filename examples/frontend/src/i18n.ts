    ...
    .init({
        ...
        resources: {
            en: {
                translation: {
                    "calendar": "Calendar",
                    "views": { // Keeping views object for backward compatibility if needed, though replaced usages
                        "day": "Day",
                        "week": "Week",
                        "month": "Month"
                    },
                    ...
                    "facility_confirm_delete_group_message": "Are you sure? All resources in this group will be deleted.",
                    "facility_confirm_delete_resource": "Delete Resource?",
                    "facility_confirm_delete_resource_message": "Are you sure you want to delete this resource?",
            ...
            ja: {
                translation: {
                    ...
                    "facility_confirm_delete_group_message": "本当に削除しますか？このグループ内のリソースも全て削除されます。",
                    "facility_confirm_delete_resource": "リソースを削除?",
                    "facility_confirm_delete_resource_message": "本当にこのリソースを削除しますか？",
