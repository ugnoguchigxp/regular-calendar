		...
		resources: {
			en: {
				translation: {
					...
					settings_calendar_orientation: "Calendar Orientation",
					settings_facility_orientation: "Facility Orientation",
					option_horizontal: "Standard (Vertical Time)",
					option_vertical: "Switched (Horizontal Time)",
					settings_calendar_interval: "Calendar Slot Interval",
					settings_facility_interval: "Facility Slot Interval",
					option_15m: "15 min",
					option_30m: "30 min",
					option_1h: "1 hour",
					option_2h: "2 hours",
					...
					app_header_shift_selector: "Shift Selector",
					...
					personnel_list_title: "Staff List",
			...
			ja: {
				translation: {
					...
					settings_calendar_orientation: "カレンダーの向き",
					settings_facility_orientation: "施設スケジュールの向き",
					option_horizontal: "標準 (縦の時間軸)",
					option_vertical: "入れ替え (横の時間軸)",
					settings_calendar_interval: "カレンダーの時間刻み",
					settings_facility_interval: "施設スケジュールの時間刻み",
					option_15m: "15分",
					option_30m: "30分",
					option_1h: "1時間",
					option_2h: "2時間",
					...
					app_header_shift_selector: "シフト指定",
					...
					personnel_no_results: "該当する職員は見つかりませんでした",
					personnel_all_departments: "全ての部署",
